...
namespace Jot.Tests
{
    ...
    public class StateTrackerTests
    {
        ...
        public void UsesConfigurationInitializer()
        {
            ...
            stateTracker1.ConfigurationInitializers.Add(new FooConfigurationInitializer());//add initializer
        ...
        public void WorksProperlyWithConfigurationInitializer()
        {
            ...
            var stateTracker1 = CreateStateTracker();
            stateTracker1.ConfigurationInitializers.Add(new FooConfigurationInitializer());//add initializer for Foo objects
            var testData1 = new Foo() { Double = 123.45f, Int = 456 };
            var cfg1 = stateTracker1.Configure(testData1, "x");
            _trigger.Fire();
            ...
            stateTracker2.ConfigurationInitializers.Add(new FooConfigurationInitializer());//add initializer for Foo objects
